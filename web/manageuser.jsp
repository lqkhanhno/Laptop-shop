			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
                                            <li><a href="listmanage">Manage Product</a></li>
                                            <li class="active"><a href="listuser">Manage User</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.list}" var="i">
                            <tr>
                                ...
                                <td>${i.user}</td>
                                <td>${i.pass}</td>
                                <td><fmt:setLocale value = "en_US"/><fmt:formatNumber value = "${i.money}" type = "currency"/></td>
                                <td>${i.role}</td>
                                <c:if test="${i.uid != 1}">
                                    <td>
                                        <a href="uprole?id=${i.uid}">Up Role</a><br/>
                                        <a href="downrole?id=${i.uid}">Down Role</a><br/>
                                    </td>
                                </c:if>
                            </tr>
                        </c:forEach>
                ...
                <div class="store-filter clearfix">
                    <c:set var="page" value="${requestScope.page}"/>
                        ...
                        <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                            <li><a class="${i==page?"active":""}" href="listuser?page=${i}">${i}</a></li>
                        </c:forEach>
                        </ul>
                </div>
            </div>
