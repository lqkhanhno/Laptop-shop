                ...
                <form action="edituser" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="password" type="text" class="form-control" value="${user.password}" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input name="email" type="text" class="form-control" value="${user.email}" requireded>
                            </div>
                            <div class="form-group">
                                <label>Role</label>
                                <select name="roleID" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${requestScope.listRole}" var="s">
                                        <option value="${s.roleID}"
                                            <c:if test="${user.roleID == s.roleID}" >selected</c:if>
                                        >    
                                            ${s.roleName}</option>
                                    </c:forEach>
                                </select>
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <input name="address" type="text" class="form-control" value="${user.userAddress}" required>
                            </div>
                            <div class="form-group">
                                <label>Phone</label>
