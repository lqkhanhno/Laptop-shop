                    ...
                    <tbody>
                        <c:forEach items="${requestScope.listUser}" var="user">
                            <tr>
                                ...
                                <td>${user.email}</td>
                                <td>
                                    <c:forEach items="${requestScope.listRole}" var="s">
                                        <c:if test="${user.roleID == s.roleID}" >${s.roleName}</c:if>
                                    </c:forEach>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="edituser?id=${user.userID}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="deleteuser?id=${user.userID}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="store-filter clearfix">
                    ...
                    <ul class="store-pagination">
                        <c:forEach begin="${1}" end="${requestScope.numberPage}" var="i">
                            <li><a class="${i==page?"active":""}" href="usermanage?page=${i}">${i}</a></li>
                            </c:forEach>
                    </ul>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <form action="adduser" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input name="email" type="text" class="form-control" requireded>
                            </div>
                            <div class="form-group">
                                <label>Role</label>
