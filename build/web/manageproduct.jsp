                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <a href="#addBrand"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Brand</span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.data}" var="i">
                            <tr>
                                ...
                                <td>${i.quantity}</td>
                                <td>${i.subCat.scname}</td>
                                <td><fmt:formatDate value="${i.release_date}" pattern="dd-MM-yyyy"/></td>
                                <td>${i.sale_off}</td>
                                <td>
                                    <c:set var="id" value="${i.pid}"/>
                                    <a href="editproduct?id=${i.pid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="deleteproduct?id=${i.pid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    ...
                    <form action="addproduct" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="release_date" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Brand</label>
                                <select name="scid" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${requestScope.sclist}" var="o">
                                        <option value="${o.scid}">${o.scname}</option>
                                    </c:forEach>
                                </select>
                            </div>
